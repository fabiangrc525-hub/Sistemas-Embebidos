...
# SPDX-FileCopyrightText: Adapted for MicroPython (wrapper configuration) by [https://github.com/control-carro-embebidos], 2025
#
# SPDX-License-Identifier: MIT
"""
OV7670 Wrapper for MicroPython

Provides simplified configuration routines for the OV7670 camera.
Register configurations are based on the Adafruit CircuitPython OV7670 driver:
